  ...
  return (
    <>
      <button
        ...
        class="m-auto block mt-4 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
        type="button"
      >
      ...
      <div
        ...
        tabindex="-1"
        aria-hidden="true"
        class="fixed top-0 left-0 right-0 z-50 text-left hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full text-base"
      >
