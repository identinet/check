...
const data = [
  ...
  [
    ...
    (<ol class="list-decimal list-inside">
      <li>
        <span class="font-semibold">Self-Sovereign Digital IDs:</span>{" "}
        Merchants control their own digital identities instead of relying on
        centralized platforms.
      </li>
      <li>
        <span class="font-semibold">Verified Credentials:</span>{" "}
        When you enter a shop's URL into CHECK, we locate the merchant's DID and
        verify their attached credentials (business registrations,
        certifications, performance history).
      </li>
      <li>
        <span class="font-semibold">No Middleman Required:</span>{" "}
        Unlike traditional verification systems where companies control all
        data, DIDs allow direct verification without trusting intermediaries
      </li>
    </ol>),
  ...
  [
    ...
    (<ul class="list-disc list-inside">
      <li>
        <span class="font-semibold">Credential-Based Verification:</span>{" "}
        Instead of subjective reviews, we focus on verifiable credentials and
        factual information
      </li>
      <li>
        <span class="font-semibold">European Government Backing:</span>{" "}
        Our service is backed by the NGI Trustchain initiative, ensuring high
        standards and regulatory compliance
      </li>
      <li>
        <span class="font-semibold">Focus on Critical Transactions:</span>{" "}
        We specifically address high-value goods and cross-border digital
        purchases where trust is essential
      </li>
      <li>
        <span class="font-semibold">Two-Way Verification:</span>{" "}
        Our system allows both merchants and buyers to verify each other,
        creating a balanced ecosystem of trust
      </li>
    </ul>),
  ],
  [
            ...
            <>
              ...
              >
                <div class="text-gray-900 p-5">
                  <For each={paragraphs}>
                    {(paragraph) => <div class="mb-2">{paragraph}</div>}
                  </For>
                </div>
              </div>
            </>
